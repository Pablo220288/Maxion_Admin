...
export default function TableStaff({ allStaff }) {
  ...
  return (
    <table className="basic mt-4">
      ...
      <tbody>
        <tr key={allStaff[0]._id}>
          <td>{allStaff[0].file}</td>
          <td>
            {allStaff[0].name[0].toUpperCase() +
              allStaff[0].name.substring(1) +
              " " +
              allStaff[0].lastName[0].toUpperCase() +
              allStaff[0].lastName.substring(1)}
          </td>
          <td>
            <div className="flex gap-2 justify-end mt-2">
              ...
              >
                <Link
                  href={"/staff/edit/" + allStaff[0]._id}
              ...
              >
                <Link
                  href={"/staff/delete/" + allStaff[0]._id}
